...
public class CamadaEnlaceDadosTransmissoraControleDeErro {
  ...
  */
  public static Quadro[] camadaEnlaceDadosTransmissoraControleDeErro(Quadro[] quadro, int origem, int destino) {
    ...
    Util.imprimirNaTelaTransmissao(strConcatenada, Constantes.CRC_CODIFICADO, origem);
