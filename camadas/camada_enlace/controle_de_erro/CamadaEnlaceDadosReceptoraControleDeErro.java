...
public class CamadaEnlaceDadosReceptoraControleDeErro {
  ...
  */
  public static Quadro camadaEnlaceDadosReceptoraControleDeErro(Quadro quadro, int destino) {
     Quadro quadroControleErro = camadaEnlaceDadosReceptoraControleDeErroCRC(quadro);

    String strBits = Conversao.bitsParaString(quadroControleErro.bits);
    Util.imprimirNaTelaRecepcao(strBits, Constantes.CRC_DECODIFICADO, destino);
